...
- `docs/01-overview.md`: 프로젝트 정체성과 아키텍처 요약.
- `docs/02-core-abstractions.md`: 공통 자료구조와 용어 정리.
- `docs/03-algorithm-walkthrough.md`: 알고리즘 파이프라인 설명.
